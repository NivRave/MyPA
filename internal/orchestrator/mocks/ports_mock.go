...
// Source: github.com/nivik/mypa/internal/orchestrator (interfaces: TelegramClient,TwilioClient,AudioClient,LLMClient,CalendarClient,GmailClient,TasksClient,TavilyClient,DBClient,EventPublisher)
//
// Generated by this command:
//
//	mockgen -destination internal/orchestrator/mocks/ports_mock.go -package mocks github.com/nivik/mypa/internal/orchestrator TelegramClient,TwilioClient,AudioClient,LLMClient,CalendarClient,GmailClient,TasksClient,TavilyClient,DBClient,EventPublisher
//
...
func (m *MockDBClient) GetLastAuditSessionForUser(userID string) (*models.AuditSession, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLastAuditSessionForUser", userID)
	ret0, _ := ret[0].(*models.AuditSession)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLastAuditSessionForUser indicates an expected call of GetLastAuditSessionForUser.
func (mr *MockDBClientMockRecorder) GetLastAuditSessionForUser(userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockEventPublisher) Publish(ctx context.Context, v any) error {
	m.ctrl.T.Helper()
